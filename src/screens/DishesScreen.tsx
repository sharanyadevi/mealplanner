      ...
      <div className="pb-4">
        <div className="px-4 mb-3 flex gap-2">
          ...
          <button
            ...
            className="shrink-0 w-11 h-11 rounded-xl bg-amber-500 text-white flex items-center justify-center hover:bg-amber-600 active:scale-95 transition-all shadow-sm"
          >
            <Plus size={20} />
          </button>
        </div>
